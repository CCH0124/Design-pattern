package design.creatation.factory;
...
public abstract class Pizza {
	...
	void bake() {
		System.out.println(name + " Bake for 25 minutes at 350");
	}

	void cut() {
		System.out.println(name + " Cutting the pizza into diagonal slices");
	}

	void box() {
		System.out.println(name + " Place pizza in official PizzaStore box");
	}
